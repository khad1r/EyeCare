...
?>
    <div class="row mt-5">
        ...
        <div class="col-md-7">
            <div class="row">
                <div class="col-md-6">
                    <input type="text" name="klasifikasi_kiri" id="klasifikasi_kiri" value='<?= $klasifikasi[0]; ?>' class="form-control" readonly>
                    <img src="images/<?= $file[0]; ?>" class="img-responsive" id="kiri" style="width:100%">
                </div>
                <div class="col-md-6">
                    <input type="text" name="klasifikasi_kanan" id="klasifikasi_kanan" value='<?= $klasifikasi[1]; ?>' class="form-control" readonly>
